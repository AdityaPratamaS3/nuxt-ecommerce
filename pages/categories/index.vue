...
export default {
    ...
    head() {
        return {
            title: 'Semua Kategori - Asgar Mebel - Distributor Furniture Indonesia Resmi',
            meta: [{
                hid: 'og:title',
                name: 'og:title',
                content: 'Semua Kategori - Asgar Mebel - Distributor Furniture Indonesia Resmi'
            },
            {
                hid: 'og:site_name',
                name: 'og:site_name',
            ...
            },
            {
                hid: 'description',
                name: 'description',
                content: 'Semua Kategori dari Produk Furniture'
            },
            ]
        }
    },
