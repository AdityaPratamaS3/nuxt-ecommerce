...
export default {
    ...
    head() {
        return {
            title: `Category : ${this.category.name}  - Asgar Mebel - Distributor Furniture Indonesia Resmi`,
            meta: [{
                hid: 'og:title',
                name: 'og:title',
                content: `Category : ${this.category.name}  - Asgar Mebel - Distributor Furniture Indonesia Resmi`
            },
            {
                hid: 'og:site_name',
                name: 'og:site_name',
