                                    ...
                                    <client-only>
                                        <tr v-for="order in invoice.orders" :key="order.id" style="background: #edf2f7;">
                                            ...
                                            <td class="b-none" width="50%">
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade" ref="modal" :id="'modal-' + order.id" tabindex="-1"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">ULASAN PRODUK
                                                                </h5>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button v-if="rating.star && rating.review"
                                                                    @click.prevent="storeReview(order.id, order.product.id)"
