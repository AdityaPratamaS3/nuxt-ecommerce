    ...
    <div class="fade-in">
        <div class="text-center mb-4">
            <nuxt-link to="/" class="text-black">
                ...
                <h3 class="mt-2 font-weight-bold">ASGAR MEBEL</h3>
            </nuxt-link>
        </div>
        <div class="card-group">
            <div class="card border-top-orange border-0 shadow-sm rounded text-center">
                <div class="card-body">
                    <h1>LOGIN</h1>
                    ...
                    <form @submit.prevent="login">
                        <div class="input-group mb-3">
                            ...
                            <input class="form-control" v-model="user.email" :class="{ 'is-invalid': validation.email }"
