                        ...
                        <div class="card-body bg-light-custom text-center rounded-bottom">
                            ...
                            <client-only>
                                <vue-star-rating :rating="parseFloat(product.reviews_avg_rating)" :increment="0.5"
                                    :star-size="20" :read-only="true" :show-rating="false" :inline="true"></vue-star-rating>
...
export default {
    ...
    head() {
        return {
            title: 'Products - Asgar Mebel - Distributor Furniture Indonesia Resmi',
            meta: [{
                hid: 'og:title',
                name: 'og:title',
                content: 'Asgar Mebel - Distributor Furniture Indonesia Resmi'
            },
            {
                hid: 'og:site_name',
                name: 'og:site_name',
                content: 'Products - Furniture - Distributor Asgar Mebel Indonesia Resmi'
            },
            {
                hid: 'og:image',
                name: 'og:image',
            ...
            },
            {
                hid: 'description',
                name: 'description',
                content: 'Jual Produk Original Furniture Indonesia Bergaransi Resmi'
            },
            ]
        }
    },
