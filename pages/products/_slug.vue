        ...
        <div class="fade-in">
                    ...
                    <div class="card border-0 rounded shadow-sm">
                        <div class="card-body">
                            ...
                            <button @click="addToCart(product.id, calculateDiscount(product), product.weight)"
                                class="btn btn-lg btn-warning border-0 shadow-sm"><i class="fa fa-shopping-cart"></i> TAMBAH
                                KE
                                KERANJANG</button>
                        </div>
                    </div>
            ...
            <div class="row mt-4">
                <div class="col-md-12">
                    <div class="card border-0 rounded shadow-sm">
                        <div class="card-body">
                            <h5><i class="fa fa-comments"></i> ULASAN PRODUK ( <strong>{{ product.reviews_count }}</strong>
                                ulasan )</h5>
                            <hr>
