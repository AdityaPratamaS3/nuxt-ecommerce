            ...
            <li class="c-header-nav-item dropdown"><a class="c-header-nav-link" data-toggle="dropdown" href="#"
                ...
                <div class="dropdown-menu dropdown-menu-right pt-0">
                    ...
                    <a class="dropdown-item" href="#">
                        ...
                        <a href="/admin/products" class="dropdown-item">
                            <svg class="c-icon mr-2">
                                <use xlink:href="@/node_modules/@coreui/icons/sprites/free.svg#cil-layers"></use>
                            </svg> Products
                        </a>
                        <a href="/admin/invoices" class="dropdown-item">
                            <svg class="c-icon mr-2">
                        ...
                        <a href="/admin/sliders" class="dropdown-item">
                            <svg class="c-icon mr-2">
                    ...
                    <div class="dropdown-divider" href="/admin/invoices"></div>
